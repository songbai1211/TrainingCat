...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CDZPicker/CDZPicker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JCChoosePhoneManager/JCChoosePhoneManager.framework"
